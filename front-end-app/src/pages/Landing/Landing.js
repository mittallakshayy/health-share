    ...
    <div>
      <div className="home-container">
        <div className="home-banner-container">
          <div className="home-text-section">
            <h1 className="primary-heading">
              Learning from the experiences of health professionals through the
              Covid-19 pandemic
            </h1>
            <button
        ...
        <div id="about-section" className="about-section">
          ...
          <h6>
            HealthShare offers a rich collection of stories and insights to
            deepen your understanding of frontline medical experiences during
          ...
          <div className="about-cards">
            <div className="about-card">
              ...
              <p>
                Welcome to HealthShare! Our innovative online platform gathers
                and organizes the heartfelt stories shared by healthcare
                professionals on social media during the COVID-19 pandemic.
                Using advanced machine learning and data mining, we transform
                scattered information from various sources into a structured and
                accessible database, inviting everyone to explore these valuable
                insights.
              </p>
            </div>
            ...
            <div className="about-card">
              ...
              <p>
                HealthShare is designed for everyone—health professionals,
                researchers, policymakers, and the curious public. We provide a
                unique glimpse into the experiences of healthcare workers during
                these challenging times. By amplifying their voices, we enhance
                understanding and inform better decisions that lead to improved
            ...
            <div className="about-card">
              ...
              <p>
                At the core of HealthShare is our dedication to frontline
                workers. By showcasing their diverse experiences, we aim to
                drive targeted interventions and policies that strengthen health
                system resilience. Join us in our mission to uplift healthcare
                systems and communities, ensuring better health outcomes for
                all!
              </p>
            </div>
          </div>
      ...
      <div className="glimpse-section">
        ...
        <h6>
          HealthShare offers a rich collection of stories and insights to deepen
          your understanding of frontline medical experiences during the
          COVID-19 pandemic.
        </h6>
